...
class Robot:
    ...
    def set_params(self, msg):
        gp = self.gait.p
        safe_ranges = {
            "height_stand": (20.0, 140.0),
            "height_rest": (20.0, 140.0),
            "stance_reach": (80.0, 180.0),
            "step_len": (0.0, 40.0),
            "step_height": (0.0, 35.0),
            "freq_hz": (0.0, 1.5),
            "speed_scale": (0.0, 1.5),
            "step_speed": (0.0, 1.5),
            "stride_scale": (0.0, 2.0),
            "lift_scale": (0.0, 2.0),
            "coxa_gain": (0.0, 1.5),
            "yaw_step_deg": (0.0, 20.0),
            "turn_scale": (0.0, 1.5),
        }
        clamped = []
